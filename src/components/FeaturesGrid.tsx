      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-1 gap-4 sm:gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="card bg-gray-800 p-4 sm:p-6 rounded-lg sm:rounded-xl hover:bg-gray-700 transition-all duration-300 transform hover:-translate-y-1">
            <div className="h-10 w-10 sm:h-14 sm:w-14 bg-[#751731]/20 rounded-lg flex items-center justify-center mb-4 sm:mb-6">
              <svg className="w-6 h-6 sm:w-8 sm:h-8 text-[#751731]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Community Card */}
          <div className="card bg-gray-800 p-4 sm:p-6 rounded-lg sm:rounded-xl hover:bg-gray-700 transition-all duration-300 transform hover:-translate-y-1">
            <div className="h-10 w-10 sm:h-14 sm:w-14 bg-[#F4D165]/20 rounded-lg flex items-center justify-center mb-4 sm:mb-6">
              <svg className="w-6 h-6 sm:w-8 sm:h-8 text-[#F4D165]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
